                ...
                <div className="columns margin-t-50">
                    <div className="column is-4-desktop">
                        <div className="testimonial-box hover-effect margin-t-30">
                            ...
                            <h5 className="has-text-centered text-uppercase padding-t-15">Jane Doe - <span className="text-muted text-capitalize">JaneX</span></h5>
                        </div>
                    </div>
                    <div className="column is-4-desktop">
                        <div className="testimonial-box hover-effect margin-t-30">
                            ...
                            <h5 className="has-text-centered text-uppercase padding-t-15">John Doe - <span className="text-muted text-capitalize">Electronic Arts</span></h5>
                        </div>
                    </div>
                    <div className="column is-4-desktop">
                        <div className="testimonial-box hover-effect margin-t-30">
                            ...
                            <h5 className="has-text-centered text-uppercase padding-t-15">Jack Doe - <span className="text-muted text-capitalize">Infinity Worlds</span></h5>
                        </div>
                    </div>
                </div>
            </div>
