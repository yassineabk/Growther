...
export const ActionModal = ({action, valid_answer_check, action_done, valid_url_check})=>{
    ...
    switch(action.provider.toLowerCase()){
            ...
            switch(action.type.toLowerCase()){
                case "view post":
                    return(
                        <iframe
                            id={"iframe"}
                            onLoad={(event)=> action_done(event)}
                ...
                case "visit page":
                    return (
                        <VisitSocialMedia link={action.url} action_done={(event)=> action_done(event)} />
                    )
                case "like post":
                    return null
                default:
        ...
        case "tiktok":
            switch(action.type.toLowerCase()){
                case "watch video":
                    return <VisitSocialMedia link={action.url} action_done={(event)=> action_done(event)} />
                case "submit video":
