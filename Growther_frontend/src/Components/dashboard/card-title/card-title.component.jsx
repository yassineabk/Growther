    ...
    return(
        <div className="list-title-container is-flex is-flex-direction-row is-justify-content-space-between is-align-items-center">
            ...
            <div className="is-flex is-flex-direction-row is-align-items-center">
                ...
                {isBrand === "true" ?
                    [
                        <ShowMoreButton clickEvent={event => {
                            var state = {clear: true}
                            event.preventDefault()
                            history.push(addNew, state)
                        }} direction={direction} id="addNewButton" showMore={addNew} icon={require("../../../assets/icons/plus.png").default} />,
                        <ShowMoreButton clickEvent={event =>{
                            event.preventDefault()
                            if(showMore){
                                history.push(showMore)
                            }
                        }} direction={direction} showMore={showMore} icon={require("../../../assets/icons/right-arrow.png").default} />
                    ] : null
                }
            </div>
        </div>
